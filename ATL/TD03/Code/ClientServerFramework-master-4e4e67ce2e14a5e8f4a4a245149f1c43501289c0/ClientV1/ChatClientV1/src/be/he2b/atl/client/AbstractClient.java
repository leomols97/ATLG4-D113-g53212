 ...
 * subclass. Several other hook methods may also be overridden.<p>
 *
...
public abstract class AbstractClient extends Observable implements Runnable {
     ...
     * communicate with the server. This method can be overridden, but if so it
